 ...
 *
 */
public class LightLocalizeHere {
	 ...
	 */
	public LightLocalizeHere(TwoWheeledRobot robot, LightSensor ls) {
	...
	public void doLocalization() {
		...
		odo.setPosition(new double [] {odo.getX() + xDist, odo.getY() + yDist, newTheta}, new boolean [] {true, true, true});
		//robot.turnTo(0);
